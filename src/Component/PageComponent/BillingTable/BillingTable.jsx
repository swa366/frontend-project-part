...
function BillingTable({OrderList, Customerinfo}) {
  ...
  return (
    <div>
      ...
      <div className="flex justify-end  w-11/12">
        <button  onClick={()=>{submit()}} className="bg-green-600 text-white  font-bold capitalize px-5 py-2 rounded-md hover:bg-opacity-70 ">
          proceed to pay
        </button>
      </div>
    </div>
